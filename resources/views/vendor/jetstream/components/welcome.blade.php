            ...
            <div class="card-body bg-white px-5 py-3 border-bottom rounded-top">
                <div class="mx-3 my-3">
                    ...
                    <div class="text-muted">
                        This is the dashboard, here you can manage your warehouses and flowers
                    </div>
                </div>
            </div>
            <div class="row g-0">
                <div class="col-md-6 pr-0">
                    <div class="card-body border-right border-bottom p-3 h-100">
                        <div class="d-flex flex-row bd-highlight mb-3">
                            ...
                            <div class="pl-3">
                                <div class="mb-2">
                                    <a href="https://laravel.com/docs" class="h5 font-weight-bolder text-decoration-none text-dark">Warehouses</a>
                                </div>
                                <p class="text-muted">
                                </p>
                                <a href="{{ route('warehouses') }}" class="text-decoration-none">
                ...
                <div class="col-md-6 pl-0">
                    <div class="card-body border-bottom p-3 h-100">
                        <div class="d-flex flex-row bd-highlight mb-3">
                            ...
                            <div class="pl-3">
                                <div class="mb-2">
                                    <a href="{{ route('flowers') }}" class="h5 font-weight-bolder text-decoration-none text-dark">Flowers</a>
                                </div>
                                <a href="{{ route('flowers') }}" class="text-decoration-none">
                                    <div class="mt-3 d-flex align-content-center font-weight-bold text-primary">
                                        <div>manage</div>
